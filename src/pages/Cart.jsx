          ...
          <div className='flex flex-col justify-between mt-8 space-x-10 md:flex-row'>
                  ...
                  <div key={product.id} className="flex items-center justify-between border-b p-3">
                    ...
                    <div className="flex space-x-12 items-center">
                      ...
                      <div className="flex border items-center justify-center">
                        <button className="border-r text-xl font-bold px-1.5">-</button>
            ...
            <div className="md:w-1/3 bg-white p-6 rounded-lg shadow-md border">
              ...
              <div className="mb-4 border-b pb-2">
                ...
                <button className='text-orange-500 hover:underline mt-1 ml-2'>Change Address</button>
              </div>
              <div className='flex justify-between mb-4'>
               <span>Total Price:</span>
               <span>{cart.totalPrice.toFixed(2)}</span>
              </div>
              <button className='w-full text-white bg-red-600 py-2 hover:bg-red-800'>Proced to Checkout</button>
            </div>
          </div>
        </div>
      ) : null}
